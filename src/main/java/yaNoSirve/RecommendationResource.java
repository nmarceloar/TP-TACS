...
public class RecommendationResource {
	 ...
	 * http://localhost:8080/api/recommendations/one/1?st=acp Ver si el codigo
	 * de error retornado corresponde.
	 *
	 * @param state
	 */
	@PUT
	...
	public Recommendation getRecommendationById(@PathParam("idRec") String id) {
		return this.srvRecom.getRecommendationById(Integer.parseInt(id));
	}
	...
	public List<Recommendation> getRecommendationsByUser(
		...
		return this.srvRecom.getRecommendationsOfUser(id);
	}
