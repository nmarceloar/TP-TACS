...
public class FriendsResource {
    ...
    public List<Passenger> getAmigosDeUsuario(
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    public boolean getSonAmigos(
        @PathParam("idUser") String id,
        ...
        if (pjSrv.getFriendsOfPassenger(id)
            .contains(idFriend)) {
            return true;
        }
        return false;
    ...
    public Response assignFriend(
        ...
        String result =
            "El usuario " + idUser + " es amigo del usuario " + idFriend;
