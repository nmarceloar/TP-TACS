...
public class GetAirportInformationByCityOrAirportNameResponse {
	...
	/**
	 * Gets the value of the getAirportInformationByCityOrAirportNameResult
	 * property.
	 * 
	...
	public String getGetAirportInformationByCityOrAirportNameResult() {
		...
		return this.getAirportInformationByCityOrAirportNameResult;
	}
	
	/**
	 * Sets the value of the getAirportInformationByCityOrAirportNameResult
	 * property.
	 * 
	 * @param value
	 ...
	 * 
	 */
	public void setGetAirportInformationByCityOrAirportNameResult(
	    final String value) {
