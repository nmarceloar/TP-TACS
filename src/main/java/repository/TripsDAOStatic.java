...
public class TripsDAOStatic implements TripsDAO {
    ...
    public TripsDAOStatic() {
        ...
        Trip viaje1 = new Trip(1,"Buenos Aires", "San Pablo", Arrays.asList(seg1));
        ...
        Trip viaje2 = new Trip(3,"Roma", "Paris", Arrays.asList(seg2));
        ...
        Trip viaje3 = new Trip(3,"Berlin", "Amsterdam", Arrays.asList(seg3));
        ...
        Trip viaje4 = new Trip(5,"Buenos Aires", "San Pablo", Arrays.asList(seg4));
