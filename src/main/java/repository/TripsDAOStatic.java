...
//
//		Trip viaje1 = new Trip("10153253398579452", "Buenos Aires",
//				"San Pablo", "4500 ARS", Arrays.asList(seg1));
...
//
//		Trip viaje2 = new Trip("10153253398579452", "Roma", "Paris",
//				"4500 ARS", Arrays.asList(seg2));
...
//
//		Trip viaje3 = new Trip("10206028316763565", "Berlin", "Amsterdam",
//				"4500 ARS", Arrays.asList(seg3));
...
//
//		Trip viaje4 = new Trip("10206028316763565", "Fortaleza", "Madrid",
//				"4500 ARS", Arrays.asList(seg4));
