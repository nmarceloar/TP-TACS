...
public class TripsDAOStatic implements TripsDAO {
    ...
    public TripsDAOStatic() {
        ...
        Trip viaje1 = new Trip(10153253398579452L, Arrays.asList(seg1));
        ...
        Trip viaje2 = new Trip(10153253398579452L, Arrays.asList(seg2));
        ...
        Trip viaje3 = new Trip(10206028316763565L, Arrays.asList(seg3));
        ...
        Trip viaje4 = new Trip(10206028316763565L, Arrays.asList(seg4));
