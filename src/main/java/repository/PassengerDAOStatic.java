...
public class PassengerDAOStatic implements PassengerDAO {
	...
	public PassengerDAOStatic() {
		...
		Passenger pMartin = new Passenger("10206028316763565", "Martin",
				"De Ciervo", "11", new ArrayList());
		Passenger pFlavio = new Passenger("10153253398579452", "Flavio",
				"Pietrolati", "22", new ArrayList());
