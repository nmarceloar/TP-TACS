...
public class OfyRecommendationsRepositoryImplTest extends BaseOfyTest {
	...
	public void findByIdTest() {
		...
		Assert.assertEquals(trip.getId(), reco.getTrip()
			.getId());
	...
	public void findByOwnerTest() {
		...
		Assert.assertEquals("name1", encontrados1.get(0)
			.getOwner()
			.getName());
	...
	public void findByOwnerAndStatusTest() {
		...
		List<OfyRecommendation> listado = recommendationRepo.findByOwnerAndStatus(owner,
	...
	public void findByTargetAndStatusTest() {
		...
		List<OfyRecommendation> listado = recommendationRepo.findByTargetAndStatus(target,
			Recommendation.Status.PENDING);
	...
	public void removeAllTest() {
		...
		Assert.assertEquals(0, recommendationRepo.findAll()
			.size());
	}
