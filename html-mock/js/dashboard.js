...
$(function(){
	...
	$("#btnViajar").click(function(event){
		...
		//uso la respuesta para armar el html que incluyo con la función getViajeHTML
		contViajes++;
...
function getViajeHTML(idViaje,origen,destino){
	return '<div class="list-group-item" id="'+idViaje+'">'+
				'<h3 class="list-group-item-heading"><a href="#">Viaje 1. Desde '+origen+' a '+destino+'</a></h3>'+
